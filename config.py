...
sound_click_X_O=pygame.mixer.Sound('assets/images/click_X_O_sound.wav')
sound_win=pygame.mixer.Sound('assets/images/sound_win.mp3')
sound_click=pygame.mixer.Sound('assets/images/mouse_click.wav')
sound_menu=pygame.mixer.Sound('assets/images/music_loop_6.mp3')